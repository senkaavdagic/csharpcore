...
namespace NorthwindML.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly static string[] countries = new[] {"Germany", "UK", "US"};
        ...
        public IActionResult GenerateDatasets()
        {
            ...
            IEnumerable<ProductCobought> coboughtProducts = ordersInCountry.SelectMany(order => from lineItem1 in order.OrderDetails from lineItem2 in order.OrderDetails select new ProductCobought
            {
        ...
        public IActionResult TrainModels()
        {
            ...
            foreach (string country in countries)
            {
                ...
                var options = new MatrixFactorizationTrainer.Options
                {
                    ...
                    LossFunction = MatrixFactorizationTrainer.LossFunctionType.SquareLossOneClass,Alpha=0.01,Lambda=0.25,C=0.00001
                };
